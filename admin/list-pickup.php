...
<body>
    <section class="home-section mt-5">
        ...
        <h5 class="mt-2 mb-5 text-center">รายการสั่งซื้อสินค้าที่รอจ่ายชำระ</h5>
        <div>
            <table class="table" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td class="text-center">
                            <h6>รวมยอดสั่งซื้อสุทธิ</h6>
                        </td>
                        <td class="text-center">
                            <h6><?= number_format($total, 2) ?> บาท&nbsp;</h6>
                        </td>
                    </tr>
                </tbody>
            </table> <?php
                        ...
                        $mpdf->Output('report-pickup.pdf');  //สร้างไฟล์ PDF ชื่อว่า myReport.pdf
                        ob_end_flush();                 // ปิดการแสดงผลข้อมูลของไฟล์ HTML ณ จุดนี้
                        ?>
            <div class="input-box button text-center mb-5">
                <a href="report-pickup.pdf"><button class="btn btn-success">แปลงไฟล์ PDF</button> </a>
