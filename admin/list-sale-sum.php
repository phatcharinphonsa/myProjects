...
<body>
    <section class="home-section mt-5">
        ...
        <h5 class="mt-2 mb-5 text-center">รายการขาย</h5>

        <table class="table" style="width: 100%;">
            <thead>
                <tr>
                    <th style="width:5%" class="text-center">ลำดับ</th>
                    <th class="text-center">เลขที่ใบขาย</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    $mpdf->Output('report-sale-sum.pdf');  //สร้างไฟล์ PDF ชื่อว่า myReport.pdf
                    ob_end_flush();                 // ปิดการแสดงผลข้อมูลของไฟล์ HTML ณ จุดนี้
                    ?>
        <div class="input-box button text-center mb-5">
            <a href="report-sale-sum.pdf"><button class="btn btn-success">แปลงไฟล์ PDF</button> </a>
