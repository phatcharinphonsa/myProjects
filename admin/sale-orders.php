...
<body>
    ...
    <section class="home-section justify-center mt-5">
        <div class="con">
            <h3>จัดการข้อมูลรายการขายสินค้า
                <a type="button" class="btn btn-success" href="show-sale.php">
                    เพิ่มรายการขาย
                </a>
            </h3>
            <div class="table-responsive">
                <table id="myTable" class="display" style="width: 100%;">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $sql = "SELECT * FROM sale JOIN `customers` ON `sale`.`cus_id` = `customers`.`cus_id` JOIN `users` ON `sale`.`userid` = `users`.`userid` ORDER BY reg_date DESC;";
    ...
    <div class="modal fade mt-5" id="insertModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" enctype="multipart/form-data" class="modal-content" action="#">
