            ...
            <table class="table" style="width: 100%;">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">เลขที่ใบสั่งซื้อสินค้า</th>
                        <th>ร้านตัวแทน</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        $mpdf->Output('report-success.pdf');  //สร้างไฟล์ PDF ชื่อว่า myReport.pdf
                        ob_end_flush();                 // ปิดการแสดงผลข้อมูลของไฟล์ HTML ณ จุดนี้
                        ?>
            <div class="input-box button text-center mb-5">
                <a href="report-success.pdf"><button class="btn btn-success">แปลงไฟล์ PDF</button> </a>
