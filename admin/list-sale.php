...
<body>
    <section class="home-section mt-5">
        ...
        <h5 class="mt-5 mb-5 text-center">รายการขายสินค้าที่รอจัดส่ง</h5>
        <div>
            <table class="table" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        $mpdf->Output('report-sale.pdf');  //สร้างไฟล์ PDF ชื่อว่า myReport.pdf
                        ob_end_flush();                 // ปิดการแสดงผลข้อมูลของไฟล์ HTML ณ จุดนี้
                        ?>
            <div class="input-box button text-center mb-5">
                <a href="report-sale.pdf"><button class="btn btn-success">แปลงไฟล์ PDF</button> </a>
