...
<head>
    ...
    <title>ตารางข้อมูลสินค้า โดย <?php echo $name; ?></title>
...
<body>
            ...
            <div class="table-responsive">
                <table id="myTable" class="display" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        $i = 1;
                        $sql =
                            "SELECT furniture.fur_id, furniture.fur_name, furniture.fur_price, furniture.amount,furniture.fur_sale, furnituretype.furtype_name 
                        FROM furniture JOIN furnituretype ON furniture.furtype_id = furnituretype.furtype_id ORDER BY fur_id DESC";
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php echo number_format($row['fur_price'], 2); ?>
                                </td>
                                <td class="text-center">
                                ...
                                <td>
                                    <a href='./edit-furnitures.php?fur_id=<?php echo $row['fur_id']; ?>'>
                                ...
                                <td>
                                    <a href='?action=delete&fur_id=<?php echo $row['fur_id']; ?>'>
    ...
    <div class="modal fade mt-5" id="insertModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" enctype="multipart/form-data" class="modal-content" action="./insert-furnitures.php">
                <div class="modal-content">
                    <div class="modal-header">
                        <p class="modal-title" id="exampleModalLabel">เพิ่มข้อมูลสินค้า</p>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <label class="mb-1">รหัสสินค้า</label>
                        <div class="input-group mb-2">
                            <input type="text" class="form-control" name="fur_id" id="fur_id" maxlength="7" required>
                        </div>
                        ...
                        <select class="form-select form-select mb-3" aria-label=".form-select example" name="furtype_id" required>
                            <option selected hidden value="1">เลือกประเภทสินค้า</option>
                            <?php
                        ...
                        <div class="input-group mb-2">
                            <input type="text" class="form-control" name="fur_name" id="fur_name" required>
                        </div>
                        <label class="mb-1">ราคาซื้อ</label>
                        <div class="input-group mb-2">
                            <input type="text" class="form-control" name="fur_price" id="fur_price" OnKeyPress="return chkNumber(this)" required>
                        </div>
                        <label class="mb-1">ราคาขาย</label>
                        <div class="input-group mb-2">
                            <input type="text" class="form-control" name="fur_sale" id="fur_sale" OnKeyPress="return chkNumber(this)" required>
                        </div>
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'delete') {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = 'furnitures.php?action=confirm&fur_id=" . $fur_id . "'
            }else{
