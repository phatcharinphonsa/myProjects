...
<body>
    <section class="home-section justify-center mt-5">
        <div class="con">
            <h3>จัดการข้อมูลรายการสั่งซื้อสินค้า
                <a type="button" class="btn btn-success" href="show-product.php">
                    เพิ่มรายการสั่งซื้อ
                </a>
            </h3>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?= $row['order_status'] == 0 ? " กำลังดำเนินการ" : "จ่ายชำระ รับสินค้าเรียบร้อย" ?>
                                </td>
                                <td>
            ...
            <form method="POST" action="./stock.php" class="modal-content">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <label class="mb-1">ชื่อผู้รับ</label>
                        <select class="form-select form-select mb-3" aria-label=".form-select example" name="user_id" required>
                            <option hidden value="">เลือกชื่อผู้รับสินค้า</option>
                            <?php
                            $sql_type = "SELECT * FROM users";
                            $rs_type = mysqli_query($conn, $sql_type);
                            while ($row_type = mysqli_fetch_array($rs_type)) {
                                echo "<option value='" . $row_type['userid'] . "'>" . $row_type['name'] . "</option>";
                            }
                            ?>
                        </select>
