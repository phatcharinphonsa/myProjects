...
<head>
    ...
    <title>สังซื้อสินค้าสำเร็จ โดย <?php echo $name; ?></title>
...
<body>
    ...
    <section class="home-section mt-5">
        <div class="con">
            <h5 class="text-center">เลขที่ใบสั่งซื้อ :
            </h5>
            <div>
                        ...
                        <div class="card mb-4 ">
                            ...
                            <div class="table-responsive mt-3">
                                <div class="col-md-12 mb-5">
                                    <label>ชื่อร้านตัวแทน : <?php echo $row_pro['fur_id']; ?></label>
                                    <label>ชื่อผู้ขาย : <?php echo $row_pro['fur_id']; ?></label>
