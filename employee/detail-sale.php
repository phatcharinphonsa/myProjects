...
<head>
    ...
    <title>รายละเอียดการขายสินค้า <?php echo $name; ?></title>
                ...
                <div class="container mt-3 mb-2">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            $i = 1;
                            $sql = "SELECT * FROM sale_detail d, furniture p, sale t WHERE d.saleID = t.saleID 
                            AND d.fur_id=p.fur_id AND d.saleID='$ids' ORDER BY d.fur_id";
                            $sum_total = 0;
